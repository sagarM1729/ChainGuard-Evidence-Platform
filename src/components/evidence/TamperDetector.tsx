              ...
              <div className="space-y-2 w-full">
                ...
                <div className="mt-3 p-3 bg-white dark:bg-slate-950 rounded border text-xs font-mono space-y-1 overflow-x-auto">
                  ...
                  <div className="flex flex-col sm:flex-row sm:gap-4 mt-2 pt-2 border-t border-slate-100">
                     ...
                     <span className={`${result.isChainVerified === true ? 'text-green-600' : result.isChainVerified === false ? 'text-red-600' : 'text-yellow-600'} font-bold`}>
                        {result.isChainVerified === true
                          ? "DB CHAIN INTACT (File Tampered Externally)"
                          : result.isChainVerified === false
                          ? "MERKLE ROOT MISMATCH (DB TAMPERED)"
